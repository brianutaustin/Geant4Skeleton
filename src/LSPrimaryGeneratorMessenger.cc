...
LSPrimaryGeneratorMessenger::LSPrimaryGeneratorMessenger(LSPrimaryGeneratorAction * Gun)
  : Action(Gun) {
...
LSPrimaryGeneratorMessenger::~LSPrimaryGeneratorMessenger() {
  delete CRYDir;
  delete InputCmd;
  delete UpdateCmd;
  delete FileCmd;
...
void LSPrimaryGeneratorMessenger::SetNewValue(
